...
class Order extends Model
{
    ...
    {
        return $this->hasOne(PosOrderAdditionalDtl::class,'order_id');
    }
    ...
    {
        return $this->hasMany(KitchenOrderStatusLog::class, 'order_id','id');
    }
    ...
    public function scopeNotDigitalOrder($query)
    {
        return $query->where(function ($q){
            $q->whereNotIn('payment_method', ['digital_payment','offline_payment'])->orWhere('order_status', '!=','pending');
        });
