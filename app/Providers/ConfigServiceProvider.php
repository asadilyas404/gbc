    ...
    public function boot()
    {
        ...
        try {
            ...
            if ($pagination) {
                ...
                Config::set('default_pagination', 1000);
            }
            ...
            $businessSetting = (boolean)BusinessSetting::where(['key' => 'local_storage'])->first();
            $config = isset($businessSetting->value) ? $businessSetting->value : null;
            if ($credentials) {
