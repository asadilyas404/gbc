...
if (! function_exists('order_place')) {
    ...
    function order_place($data)
    {
        ...
        OrderLogic::update_unpaid_order_payment($order->id, $data->payment_method);
        //PlaceOrderMail
        try {
...
if (! function_exists('sub_success')) {
    function sub_success($data)
    {
        ...
        Helpers::subscription_plan_chosen($data->payer_id, $data->attribute_id, $data->payment_method,  0,  $pending_bill,  $data->attribute, $type);
        if ($type !== 'new_join') {
