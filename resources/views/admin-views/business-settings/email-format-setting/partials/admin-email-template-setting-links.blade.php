    ...
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['admin','restaurant-registration']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['admin','dm-registration']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['admin','withdraw-request']) }}">
                    {{translate('Withdraw_Request')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/admin/campaign-request') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.show', ['admin','campaign-request']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['admin','update-advertisement']) }}">
