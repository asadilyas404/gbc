    ...
    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
        ...
        <ul class="nav nav-tabs border-0 nav--tabs nav--pills">
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','registration']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','approve']) }}">
                    {{translate('New_Restaurant_Approval')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/restaurant/deny') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','suspend']) }}">
                    {{translate('Account_Suspend')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/business-settings/email-setup/restaurant/unsuspend') ? 'active' : '' }}"
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','unsuspend']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','withdraw-approve']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','withdraw-deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','campaign-request']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','campaign-approve']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','campaign-deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','advertisement-create']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','advertisement-approved']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','advertisement-deny']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','advertisement-resume']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','advertisement-pause']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','subscription-successful']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','subscription-renew']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','subscription-shift']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','subscription-cancel']) }}">
            ...
            {{-- <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','subscription-deadline']) }}">
            ...
            <li class="nav-item">
                ...
                href="{{ route('admin.business-settings.email-setup.show', ['restaurant','subscription-plan_upadte']) }}">
