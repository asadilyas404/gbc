...
$collected_cash = isset($wallet->collected_cash) && is_numeric($wallet->collected_cash) ? $wallet->collected_cash : 0;
$Payable_Balance = $collected_cash > 0 ? 1 : 0;

$cash_in_hand_overflow = \App\Models\BusinessSetting::where('key', 'cash_in_hand_overflow_restaurant')->first()->value ?? 0;

$cash_in_hand_overflow_restaurant_amount = \App\Models\BusinessSetting::where('key', 'cash_in_hand_overflow_restaurant_amount')->first()->value ?? 0;
$cash_in_hand_overflow_restaurant_amount = is_numeric($cash_in_hand_overflow_restaurant_amount) ? (float)$cash_in_hand_overflow_restaurant_amount : 0;
