<div class="content container-fluid initial-38 new-invoice ">
    <div class="row justify-content-center" id="printableArea">
        <div class="col-md-12">
            ...
            <div class="initial-38-1">
                ...
                <div class="text-center pt-3 mb-3">
                    ...
                    @if ($order->restaurant->gst_status)
                        <h5 class="initial-38-4 initial-38-3 fz-12px text-center">
                            <span>{{ translate('Gst_No') }}</span> <span>:</span>
                ...
                <h5 class="d-flex justify-content-between gap-2">
                    ...
                    <span
                        class="">{{ $order->order_type == 'delivery' ? translate('Home_Delivery') : translate($order->order_type) }}</span>
                </h5>
        ...
        <div class="d-flex flex-row justify-content-between">
            <span class="text-capitalize d-flex"><span>{{ translate('Paid_by') }}</span> <span>:</span>
        ...
        <div class="d-flex flex-row justify-content-between">
            <span>{{ translate('messages.Cash') }}: {{ \App\CentralLogics\Helpers::format_currency($order->pos_details->cash_paid) }}</span>
            <span>{{ translate('messages.Card') }}:
