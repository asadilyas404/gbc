...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('messages.add_new_addon') }}
            </h1>
        </div>
        <!-- End Page Header -->
        <div class="card">
            <div class="card-body">
                <form action="{{ route('vendor.addon.store') }}" method="post" class="row">
                    ...
                    @if ($language)
                        ...
                        <div class="form-group col-md-6 lang_form" id="default-form">
                            ...
                            <input type="text" name="name[]" class="form-control"
                                placeholder="{{ translate('messages.Ex :') }} {{ translate('Water') }}" required
                                maxlength="191">
                        </div>
                        ...
                        @foreach (json_decode($language) as $lang)
                            <div class="form-group col-md-6 d-none lang_form" id="{{ $lang }}-form">
                                ...
                                <input type="text" name="name[]" class="form-control h--45px"
                                    placeholder="{{ translate('Ex : New Addon ') }}" maxlength="191">
                            </div>
                    ...
                    <div class="form-group col-md-6">
                        <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.Stock_Type') }}
                        </label>
                    ...
                    <div class="form-group col-md-6 hide_this">
                        ...
                        <input type="number" min="0" id="addon_stock" max="999999999999" name="addon_stock" readonly
                            value="{{ old('addon_stock') }}" class="form-control stock_disable"
                            placeholder="{{ translate('messages.Unlimited') }}" required>
                    </div>
        ...
        <div class="card mt-4">
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper">
                    <h5 class="card-title">
                        {{ translate('messages.addon_list') }}<span class="badge badge-soft-dark ml-2"
                        ...
                        <form>
                            <div class="input-group input--group">
                                ...
                                <input type="text" name="search" value="{{ request()->search ?? null }}"
                                    class="form-control"
                                    placeholder="{{ translate('Ex : Search by Addon Name or Restaurant Name') }}">
                                        ...
                                        <div class="btn--container justify-content-center">
                                            @if (!app()->environment('local'))
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('vendor.addon.edit', ['id' => $addon['id']]) }}"
                                                ...
                                                <form action="{{ route('vendor.addon.delete', ['id' => $addon['id']]) }}"
