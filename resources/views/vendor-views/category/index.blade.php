    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if(isset($category))
                <a href="{{route('vendor.category.add')}}" class="btn btn--primary pull-right"><i class="tio-add-circle"></i> {{translate('messages.Add_New_Category')}}</a>
                @endif
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="card resturant--cate-form">
            <div class="card-body">
                <form action="{{isset($category)?route('vendor.category.update',[$category['id']]):route('vendor.category.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($categories as $key=>$category)
                        <tr>
                            ...
                            <td>
                                <form action="{{route('vendor.category.priority',$category->id)}}" class="priority-form">
                            ...
                            <td>
                                <div class="btn--container">
                                    <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                        href="{{route('vendor.category.edit',[$category['id']])}}" title="{{translate('messages.edit_category')}}"><i class="tio-edit"></i>
                                    </a>
