                    ...
                    <div class="card-body">
                        ...
                        <div class="order-btn-wraper">
                            ...
                            @if (config('canceled_by_restaurant') && $order['order_status'] != 'canceled')
                                    <a href="{{ route('vendor.pos.load-draft', ['order_id' => $order->id]) }}" class="btn w-100 mb-1 btn-sm btn-outline-danger btn--danger mt-2 btn btn--warning">
                                        Load Draft to POS
                                    </a>
                            @endif
                            @if (config('canceled_by_restaurant') && $order['order_status'] != 'canceled')
                                <a
                                    class="btn w-100 mb-2 btn-sm btn-outline-danger btn--danger mt-1 cancelled-status">{{ translate('Cancel Order') }}</a>
                            @endif
        ...
        <div class="card mb-2 mt-2">
            <div class="card-header border-0 text-center pb-0">
                ...
                @if (
                    ($restaurant->restaurant_model == 'commission' && $restaurant->self_delivery_system) ||
                        ($restaurant->restaurant_model == 'subscription' && $restaurant->restaurant_sub->self_delivery == 1))
                    <button class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target=".order-proof-modal">
