                                ...
                                @foreach ($choice->values as $k => $option)
                                    @php
                                        ...
                                        if (!empty($option->options_list_id)) {
                                            $optionsList = \App\Models\OptionsList::find($option->options_list_id);
                                    ...
                                    <div class="flex-column pb-2">
                                        ...
                                        <label
                                            ...
                                            {{ Str::limit(optional($optionsList)->name ?? $option->label, 20, '...') }}
                                            <br>
                    ...
                    @foreach (AddOn::whereIn('id', $add_ons)->active()->get() as $add_on)
                        <div class="flex-column pb-2">
                            ...
                            <input class="btn-check variation-addon-checkbox" type="checkbox"
                                ...
                                name="variation_addon_id[{{ $key }}][]" value="{{ $add_on->id }}"
                                {{ in_array($add_on->id, $selected_addon_ids) ? 'checked' : '' }} autocomplete="off">
                            <label
