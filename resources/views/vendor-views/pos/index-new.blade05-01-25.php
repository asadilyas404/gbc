                ...
                <div class="card main-content">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center" id="items">
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-sm-12 mobile-scroll" style="display: none">
                                <div class="category-scroll-container">
                                    <div class="subcategory-list">
                                        @include('vendor-views.pos._subcategory_list', ['subcategories' => $subcategories])
                                    </div>
    ...
    if ($('#add-to-cart-form input[name=quantity]').val() > 0) {
        ...
        $.ajax({
            ...
            data: $('#add-to-cart-form').serializeArray().concat([
                { name: 'product_discount', value: discountAmount },
                { name: 'product_discount_type', value: discountType }
            ...
            success: function(data) {
                if (data.error === 'quantity_error') {
                    ...
                    var currentDiscountAmount = parseFloat($('#set-discount-amount').text().replace(/[^0-9.-]+/g, '').trim()) || 0;
        ...
        document.querySelector('.sub-category-scroll-container-mobile').addEventListener('wheel', function(e) {
            e.preventDefault();
            this.scrollLeft += e.deltaY;
        });
