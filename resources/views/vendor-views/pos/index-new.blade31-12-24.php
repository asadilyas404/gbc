...
.category-item.selected {
    ...
    color: #fff;
    box-shadow: 0 4px 10px rgba(64, 169, 255, 0.5); /* Glow effect */
}
                ...
                .subcategory-name {
                    ...
                    <div class="subcategory-scroll-container">
                            <h6 class="subcategory-header">
                                {{ $categories->firstWhere('id', $category)->name ?? 'Sub Categories' }}
                            </h6>
                            ...
                            <div class="col-sm-12">
                                <div class="category-scroll-container">
                                    <div class="category-scroll">
                                         <a href="{{ url()->current() }}"
                                            class="category-item {{ empty($category) ? 'selected' : '' }}">
                                             <div class="category-icon">
                                                 <img src="{{dynamicAsset('/public/assets/admin/img/100x100/food.png')}}" alt="All Products">
                                             </div>
                                        ...
                                        @foreach ($categories as $item)
                                            <a href="{{ url()->current() }}?category_id={{ $item->id }}"
                ...
                <div class="card">
                    <div class="card-header bg-light border-0 m-1">
                        ...
                        <div class="d-flex justify-content-between">
                            <a class="btn btn-default ml-auto" id="fullscreen-btn">
                                <i class="tio-fullscreen-1-1" data-toggle="tooltip" data-placement="top" data-original-title="POS Full-Screen"></i>
                            </a>
                        </div>
                    </div>
                    <div class="w-100">
