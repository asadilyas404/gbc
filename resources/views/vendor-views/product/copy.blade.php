...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-copy"></i> {{ translate('messages.copy_food') }}</h1>
            <div class="alert alert-info">
                <i class="tio-info"></i> {{ translate('messages.copying_from') }}: <strong>{{ $originalProduct->name }}</strong>
            </div>
        </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-lg-12">
                    <div class="btn--container justify-content-end">
                        ...
                        <button type="submit" class="btn btn--primary">{{ translate('messages.create_copy') }}</button>
                    </div>
                </div>
            </div>
        </form>
            ...
            $.post({
                ...
                success: function(data) {
                    ...
                    if (data.errors) {
                        ...
                        toastr.success('{{ translate('messages.product_copied_successfully') }}', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function() {
