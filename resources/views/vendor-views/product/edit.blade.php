                            ...
                            <div class="row g-2">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_starts" class="form-control"
                                            id="available_time_starts"  value="{{ date('H:i', strtotime($product['available_time_starts'])) }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_ends" class="form-control" value="{{ date('H:i', strtotime($product['available_time_ends'])) }}"
