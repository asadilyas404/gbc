                            ...
                            @if ($language)
                                <div class="js-nav-scroller hs-nav-scroller-horizontal">
                                    <ul class="nav nav-tabs mb-4">
                                        <li class="nav-item">
                                            <a class="nav-link lang_link active" href="javascript:;"
                                                id="default-link">{{ translate('Default') }}</a>
                                        </li>
                                        @foreach (json_decode($language) as $lang)
                                            <li class="nav-item">
                                                <a class="nav-link lang_link " href="javascript:;"
                                                    id="{{ $lang }}-link">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" step="1" max="9999999999999999999999"
                                            name="est_make_time" class="form-control"
                                                ...
                                                <div class="input-group-append">
                                                  <div class="input-group-text py-0 px-2">
                                                    <label class="toggle-switch toggle-switch-sm" data-toggle="tooltip" data-placement="top" title="Change food visibility to delivery partner" for="partner_price[{{$row->p_id }}]">
                                                        <input type="checkbox" id="partner_price[{{$row->p_id }}]" class="toggle-switch-input" name="partner_price[{{$row->p_id }}][enable]" checked>
            ...
            $(document).ready(function() {                
                $("#add_new_option_button").click(function(e) {
                    ...
                    <div class="__bg-F8F9FC-card view_new_option mb-2">
                        ...
                        `][name] class="form-control new_option_name" type="text" data-count="` + count + `">
                                </div>
                                <div class="col-xl-4 col-lg-6">
                                    <div>
                ...
                <select name="options[` + count + `][printing_option]" id="" class="form-control js-select2-custom">
                    ...
                    updatestockCount();
                    $('#add_new_option>.__bg-F8F9FC-card:last').find('.add_new_view_row_class:first').find(
                        '.all_food_list').change();
                });
            });
