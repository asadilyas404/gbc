<div class="__bg-F8F9FC-card view_new_option mb-2 p-0 option-item">
    ...
    <div class="p-2">
        ...
        <div id="option_price_{{ $key }}" class="option_price">
            <div class="mt-3">
                                ...
                                <div class="col-12 px-5">
                                    <div class="row bg-white border py-2">
                                        ...
                                        @foreach ($PARTNER_VARIATION_OPTION as $row)
                                            <div class="col-md-2 col-sm-6">
                                                <label for="">{{  $row->partner_name." Extra" }} &nbsp;<span
                                                        class="form-label-secondary text-danger" data-toggle="tooltip"
                                                        data-placement="right"
                                                        data-original-title="{{ translate('messages.Required.') }}"> *
                                                    </span></label>
                                        ...
                                        <div class="col-sm-12 text-right max-sm-absolute mt-1">
                                            ...
                                            <button type="button" class="move-option-down btn btn-sm btn-outline-primary">⬇</button>
                                            <button type="button" data-id="{{ data_get($value, 'option_id') }}"
                                                class="btn btn-danger btn-sm remove_variation_option"
